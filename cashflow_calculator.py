...
components.html("""
<head>
    <meta name="description" content="Free cash flow calculator for small businesses. Visualize scenarios, forecast finances, and gain planning insights. Educational tool - verify all calculations before decisions.">
    <meta name="keywords" content="cash flow calculator, business scenario planning, financial forecasting, runway visualization">
    <meta name="author" content="Cashflow Planning">
    <meta property="og:title" content="Free Cash Flow Calculator - Business Scenario Planning Tool">
    ...
    <meta name="twitter:title" content="Cash Flow Calculator - Test Business Scenarios">
...
<div class="header-container">
    <div class="main-title">💰 Cash Flow Calculator</div>
...
if SHOW_WARNING_INSTRUCTIONS:
    header_html += f'<div class="warning-box" style="margin-top: 5px;">{WARNING_INSTRUCTIONS}</div>'
...
with st.expander("⚖️ Legal & Privacy Information"):
    ...
    - **Consult Professionals**: Always consult with qualified financial advisors, accountants, or legal professionals before making important financial or business decisions.
